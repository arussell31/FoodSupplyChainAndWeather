function recalculate(country,crop){
  ...
  $.ajax({
      ...
      success: function(data) {
        ...
        document.getElementById("projection").innerHTML = "Projecting <span style='color:black;'>" + Math.round(projection).toLocaleString("en-US") + "</span> tons of " + crop + " will be produced in " + country +" in 2022."
        if(projection<0){
